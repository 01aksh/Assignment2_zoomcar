...
export const sectionTitles = ["ABOUT US", "BLOGS", "CAREERS", "HELP& SUPPORT"];
...
export const aboutUsData = [
  ...
  {
    title: "Flying Soon? We’ll Be There!",
    details: [
  ...
  {
    title: "We’ve Got A Car For All Your Needs:",
    details: [
  ...
  {
    title: "Want A Specific Car? We’ve Got It All:",
    details: [
  ...
  {
    title: "How To Rent A Car Through Zoomcar?",
    details: [
  ...
  {
    title: "Can Zoomcar Be Used For Interstate Travel?",
    details: [
  ...
  {
    title: "Can A Zoomcar Booking Be Cancelled?",
    details: [
  ...
  {
    title: "How To Book A Zoomcar From The Airport?",
    details: [
      "No waiting for cabs or fighting the fares anymore - Zoomcar provides Airport trip services. The airport car rent service allows you to book a car from the airport & drive it home. Arrive in any city worry-free! We assure you unbeatable prices!!",
    ],
    isPoints: false,
  ...
  {
    title: "What Are The Best Cars For Long Trips?",
    details: [
  ...
  {
    title: "What Events Can I Rent A Zoomcar For?",
    details: [
